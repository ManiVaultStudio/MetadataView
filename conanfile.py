...
class MetadataViewConan(ConanFile):
    ...
    name = "MetadataView"
    description = """Table view for matrix text data with filtering, sorting and selection functionality."""
    topics = ("manivault", "plugin", "view", "metadata")
    url = "https://github.com/ManiVaultStudio/MetadataView"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/MetadataView")
        cmake.verbose = True
        return cmake
